...
var msgbox = '<div data-plus-as-tab="true" class="'+ $.prompt.options.prefix +'box '+ opts.classes.box +'">';
if(opts.useiframe && ($('object, applet').length > 0)) {
msgbox += '<iframe data-plus-as-tab="true" src="javascript:false;" style="display:block;position:absolute;z-index:-1;" class="'+ opts.prefix +'fade '+ opts.classes.fade +'"></iframe>';
} else {
msgbox +='<div data-plus-as-tab="true" class="'+ opts.prefix +'fade '+ opts.classes.fade +'"></div>';
}
msgbox += '<div data-plus-as-tab="true" class="'+ opts.prefix +' '+ opts.classes.prompt +'"><div  data-plus-as-tab="true" class="'+ opts.prefix +'container"><div class="';
